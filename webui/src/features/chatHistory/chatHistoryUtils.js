...
const CURRENT_INPUT_FILE_PROMPT = 'Continue from the latest state in the attached TOOL_GATEWAY_HISTORY.txt context. Treat it as the current working state and answer the latest user request directly.'
...
const HISTORY_TRANSCRIPT_TITLE = '# TOOL_GATEWAY_HISTORY.txt'
