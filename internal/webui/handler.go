...
</head><body><main><h1>Tool Gateway</h1><p>AI Tool Calling Gateway</p><div class="links"><a href="/admin">管理面板</a><a href="/v1/models">API 状态</a><a href="https://github.com/extheor-next/tool-gateway" target="_blank">GitHub</a></div></main></body></html>`
