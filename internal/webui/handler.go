...
<html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Tool Gateway</title>
...
</head><body><main><h1>Tool Gateway</h1><p>DeepSeek to OpenAI & Claude Compatible API</p><div class="links"><a href="/admin">管理面板</a><a href="/v1/models">API 状态</a><a href="https://github.com/CJackHwang/tool-gateway" target="_blank">GitHub</a></div></main></body></html>`
...
func resolveStaticAdminDir(preferred string) string {
	if strings.TrimSpace(os.Getenv("TOOL_GATEWAY_STATIC_ADMIN_DIR")) != "" {
