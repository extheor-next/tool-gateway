...
func TestLoadDotEnvLoadsWorkingDirectoryFileWithoutOverridingExistingEnv(t *testing.T) {
	...
	const newKey = "TOOL_GATEWAY_TEST_DOTENV_NEW"
	const keepKey = "TOOL_GATEWAY_TEST_DOTENV_KEEP"
	const quotedKey = "TOOL_GATEWAY_TEST_DOTENV_QUOTED"

	unsetEnv(t, newKey)
	unsetEnv(t, quotedKey)
	t.Setenv(keepKey, "from-env")

	content := "TOOL_GATEWAY_TEST_DOTENV_NEW=from-file\n" +
		"TOOL_GATEWAY_TEST_DOTENV_KEEP=from-file\n" +
		"TOOL_GATEWAY_TEST_DOTENV_QUOTED=\"line1\\nline2\"\n"
...
func TestLoadDotEnvStripsInlineCommentsFromUnquotedValues(t *testing.T) {
	...
	const plainKey = "TOOL_GATEWAY_TEST_DOTENV_PLAIN"
	const hashKey = "TOOL_GATEWAY_TEST_DOTENV_HASH"
	const quotedKey = "TOOL_GATEWAY_TEST_DOTENV_QUOTED_COMMENT"
	const exportKey = "TOOL_GATEWAY_TEST_DOTENV_EXPORT"
