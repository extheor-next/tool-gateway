...
func (f *fakeCompletionBackend) CreateSession(_ context.Context, a *auth.RequestAuth, _ int) (string, error) {
...
func (f *fakeCompletionBackend) GetPow(context.Context, *auth.RequestAuth, int) (string, error) {
	return "pow", nil
}

func (f *fakeCompletionBackend) UploadFile(_ context.Context, a *auth.RequestAuth, req dsclient.UploadFileRequest, _ int) (*dsclient.UploadFileResult, error) {
...
func (f *fakeCompletionBackend) CallCompletion(_ context.Context, a *auth.RequestAuth, payload map[string]any, _ string, _ int) (*http.Response, error) {
