...
func RegisterRoutes(r chi.Router, h *Handler) {
	...
	authHandler := &adminauth.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	configHandler := &adminconfig.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	settingsHandler := &adminsettings.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	proxiesHandler := &adminproxies.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	rawSamplesHandler := &adminrawsamples.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	vercelHandler := &adminvercel.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	historyHandler := &adminhistory.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	devCaptureHandler := &admindevcapture.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
	versionHandler := &adminversion.Handler{Store: deps.Store, Backend: deps.Backend, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory}
...
func adminsharedDeps(h *Handler) adminsharedDepsValue {
	...
	return adminsharedDepsValue{Store: h.Store, Backend: h.Backend, OpenAI: h.OpenAI, ChatHistory: h.ChatHistory}
}
