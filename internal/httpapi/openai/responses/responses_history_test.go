...
type responsesHistoryBackend struct {
...
func TestResponsesRecordsResponseHistory(t *testing.T) {
	...
	if !strings.Contains(item.UserInput, "Continue from the latest state in the attached TOOL_GATEWAY_HISTORY.txt context.") {
