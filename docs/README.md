# Tool Gateway 文档导航 | Documentation Index
...
- [Tool Gateway 项目价值说明](./project-value.md)
- [API -> 网页对话纯文本兼容主链路说明](./prompt-compatibility.md)
- [Tool Calling 统一语义](./toolcall-semantics.md)
- [upstream SSE 行为结构说明（逆向观察）](./upstream providerSSE行为结构说明-2026-04-05.md)
...
- [Tool Gateway project value note](./project-value.md)
...
- [upstream SSE behavior notes (reverse-engineered)](./upstream providerSSE行为结构说明-2026-04-05.md)
