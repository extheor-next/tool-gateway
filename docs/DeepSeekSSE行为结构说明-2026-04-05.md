...
| 样本 | 观察重点 |
| --- | --- |
| [longtext-deepseek-v4-flash-20260429](../tests/raw_stream_samples/longtext-deepseek-v4-flash-20260429/upstream.stream.sse) | 上游 flash 长文本流，包含 current input file 上传后的 completion 样本 |
| [longtext-deepseek-v4-pro-20260429](../tests/raw_stream_samples/longtext-deepseek-v4-pro-20260429/upstream.stream.sse) | 上游 pro 长文本流，包含文件上传上下文和较长 reasoning/content 输出 |
