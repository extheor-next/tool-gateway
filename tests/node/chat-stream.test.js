...
test('setCorsHeaders reflects requested third-party headers and blocks internal-only headers', () => {
  ...
  setCorsHeaders(res, {
    headers: {
      ...
      'access-control-request-headers': 'authorization, x-stainless-os, x-stainless-runtime, x-tool-gateway-internal-token',
  ...
  assert.equal(allowHeaders.includes('x-tool-gateway-internal-token'), false);
